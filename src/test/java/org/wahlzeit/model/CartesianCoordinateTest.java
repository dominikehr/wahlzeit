...
public class CartesianCoordinateTest {
	...
	CartesianCoordinate cartCoord4;
	CartesianCoordinate cartCoord5;
	CartesianCoordinate cartCoord6;
	CartesianCoordinate cartCoord7;
	...
	SphericCoordinate sphereCoord8;
	...
	public void setUp() {
		...
		cartCoord7 = new CartesianCoordinate(0.0,0.2,0.675654);
		...
		// 2 und 3 haben keine direkte uebereinstimmung mit den entsprechenden cartCoords
	...
	//=================== Test getters & setters ==========================
		...
		public void testGetters() {
			...
			double expectedX = 3;
			assertEquals(expectedX, cartCoord1.getX(), EPSm6);
			
			double expectedY = 4;
			assertEquals(expectedY, cartCoord1.getY(), EPSm6);
			
			double expectedZ = 6.7;
			assertEquals(expectedZ, cartCoord1.getZ() , EPSm6);
		...
		public void testSetters() {
			...
			cartCoord1.setX(1.42323);
			assertEquals(1.42323, cartCoord1.getX(), EPSm6);
			
			cartCoord1.setY(5321312.23);
			assertEquals(5321312.23, cartCoord1.getY(), EPSm6);
			
			cartCoord1.setZ(2123.4);
			assertEquals(2123.4, cartCoord1.getZ(), EPSm6);
